            ...
            <div className="col-md-12">
                ...
                <div id="main-text" className="single-post-content-wrapper p-3">
                    <blockquote className="blockquote">
                        <h3 className="mb-0 text-weight-bolder" id="blockquote">“The only thing that is stopping you from where you are to
                            where you want to go is your comfort zone”</h3>
                        <footer className="blockquote-footer">Dhaval Gaudier</footer>
                    </blockquote>
                    <h6 className="text-weight-bold" id="blocktext"> Hi there! My Name is Azucena Gonzalez. A former business professional
                    ...
                    <h6 className="text-weight-bold" id="blocktext">During my free time, I love to travel, hike, work on personal coding
